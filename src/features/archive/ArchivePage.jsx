...
export function ArchivePage({ preview = false, history, onSelectHistory, onClear }) {
  ...
  return <main className="archive-page">
    <header className="archive-title"><div><h1>{preview ? "嘉豪出没图鉴" : "人格档案"}</h1><p>{preview ? "先认识各路嘉豪与奶龙；图鉴预览不代表已解锁。" : "这里记录你已经解锁的人格与鉴定。"}</p></div><div className="archive-count"><span>已留存鉴定</span><strong>{history.length}</strong></div></header>
